...
# Objective
Bring the 3-tier stack up on your machine: npm start, environment variables, and the Vite proxy for API routing.

# Acceptance criteria
Frontend loads locally; /api/health returns healthy; you can explain how the Vite proxy routes API calls.
...![alt text](image.png)
