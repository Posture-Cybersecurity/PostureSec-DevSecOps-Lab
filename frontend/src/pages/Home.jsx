  ...
  return (
    <div>
      <div className="home-header">
        ...
        <p>The cybersecurity knowledge platform by Posture by NLNG DevSecOps Engineers for the future,, Share threat intel, security insights, and best practices.</p>
